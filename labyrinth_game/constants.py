...
ROOMS = {
    'entrance': {
        'description': 'Вы в темном входе в лабиринт. Стены покрыты мхом. '
    ...
    'trap_room': {
        ...
        'puzzle': ('Система плит активна. Чтобы пройти, назовите слово "шаг" '
                   'три раза подряд (введите "шаг шаг шаг")', 'шаг шаг шаг', 'шаг шаг шаг')
    },
    'library': {
        ...
        'puzzle': ('В одном свитке загадка: "Что растет, когда его съедают?" '
                   '(ответ одно слово)', 'резонанс', 'резонанс')
    },
    'armory': {
    ...
    'treasure_room': {
        ...
        'puzzle': ('Дверь защищена кодом. Введите код (подсказка: '
                   'это число пятикратного шага, 2*5= ? )', '10', 'десять')
    },
    'outpatient': {
        'description': 'Комната, на кушетке стоит чемоданчик с лекарствами. '
                       'Чемоданчик на кодовом замке.',
        'exits': {'south': 'trap_room', 'east': 'shop'},
        'items': ['first_aid_kit'],
        'puzzle': ('Чемоданчик с лекарствами защищена кодом. Введите код (подсказка: '
                   'это количество месяцев в году )', '12', 'двенадцать')
    },
    'shop': {
        'description': 'Магазин редкой и деликатесной пищи. '
                       'На витрине стоит свежеприготовленный снежный краб ',
        'exits': {'west': 'outpatient'},
        'items': ['snow_crab'],
        'puzzle': ('Напишите название профессии человека, который стоит за прилавком?',
                   'продавец', 'продавец')
    }
}
...
COMMANDS = {"go <direction>": "перейти в направлении (north/south/east/west)",
